...
export default function AIElectricianPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const assistantResponse = await chatWithElectrician(input);
      const assistantMessage: Message = { role: 'assistant', content: assistantResponse };
        ...
        <Card className="max-w-2xl mx-auto">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-muted-foreground md:text-lg">
              Ask "Sparky" about your electrical faults.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-6 h-96 overflow-y-auto p-4 border rounded-md bg-secondary/20">
