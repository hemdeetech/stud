      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <article>
            ...
            <div className="relative w-full aspect-video rounded-lg shadow-lg mb-8 overflow-hidden">
                <Image
                src={post.image}
                alt={post.title}
                fill
            ...
            <div className="space-y-6 text-foreground/90 text-lg leading-relaxed">
              ...
              <p className="pt-6 border-t">Ready to upgrade your home? <Link href="/contact" className="text-primary font-semibold hover:underline">Contact HDTC Solutions today</Link> for a consultation on our smart home services!</p>
            </div>
          </article>
        </div>
      </div>
